...
const Header = () => {
  return (
    <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden' style={{backgroundImage:"url('/header_img.png')"}}>
      <Navbar/>
      <div className='mx-auto text-center py-4 px-6 md:px-20 lg:px-32 text-white'>
        ...
        <div className='space-x-6 mt-16'>
            <button className='border border-white px-8 py-3 rounded cursor-pointer'>Projects</button>
            <button className='bg-blue-500 px-8 py-3 rounded cursor-pointer'>Contact Us</button>
        </div>
      </div>
    </div>
  )
