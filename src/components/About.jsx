...
const About = () => {
  return (
    <div  className='flex items-center justify-center flex-col  mx-auto p-14 md:px-20 lg:px-32  w-full overflow-hidden'>
      <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'> About<span className=' underline underline-offset-4   decoration-1 font-light'>Our Brand</span></h1>
      <p className='text-gray-500  text-center mb-8 max-w-80 mx-auto'>Passionate About Properties, Dedicated to Your Vision </p>
